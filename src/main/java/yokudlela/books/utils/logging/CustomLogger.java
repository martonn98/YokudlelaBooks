...
public class CustomLogger {
    ...
    @Pointcut(value = "@within(yokudlela.menu.utils.logging.AspectLogger) && execution(public * *(..))")
    @Order(1)
    public boolean executionOfAnyPublicMethodInAtLoggedType() {return true;}

    @Pointcut(value = "execution(* *(..)) && @annotation(yokudlela.menu.utils.logging.AspectLogger)")
    @Order(2)
